        ...
        <div className="playlist">

          {
            filteredTrack.map((track) => {
              ...
              return (
                <div className="song">
                  <img src={`http://mashupb.herokuapp.com/uploads/covers/${track._id}.jpg`} className='cover' />
                  <span className='mashup-name2'>{track.author}</span>
                  <span className='mashup-name2'>{track.track_name}</span>
                  <audio src={`http://mashupb.herokuapp.com/uploads/${track._id}.mp3`} />
                  ...
                  <button id={track.id} onClick={() => {
                    soundPlay(`http://mashupb.herokuapp.com/uploads/${track._id}.mp3`);
